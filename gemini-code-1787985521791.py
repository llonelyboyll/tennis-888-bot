...
RAPIDAPI_KEY = os.getenv("RAPIDAPI_KEY", "dbcb6f204emshf93e9e1bb342b5fp1c720djsn909778cd5b67")
...
def analyze_and_predict(match_raw, detail_raw):
    ...
    # Thuật toán định giá tỷ lệ thắng cơ bản dựa trên điểm số set/game
    p1_score = 50.0
    p2_score = 50.0
    
    try:
        # Ví dụ phân tích chuỗi tỉ số set đơn giản
        if "-" in str(score):
    ...
    while True:
        try:
            ...
            for raw in matches:
                ...
                # Tạo chữ ký trạng thái để tránh spam tin nhắn liên tục nếu tỉ số không đổi
